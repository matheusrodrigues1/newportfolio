...
const Home = () => {
  ...
  return (
    ...
    <div className="flex font-extrabold pl-7 pt-40 md:pt-20 text-5xl flex-col justify-start md:items-center h-screen w-screen">
      <div className="flex flex-row items-center pl-20 md:pl-0 gap-2 md:gap-[1.18rem] mb-3 md:mb-8 text-zinc-700">
          <a href="https://www.linkedin.com/in/matheus-rodrigues-1a1899231/" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon className="w-7 md:w-10 transition-transform transform hover:-translate-y-1 hover:text-teal-500" icon={faLinkedin} />
          </a>
          <a href="https://github.com/matheusrodrigues1" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon className="w-7 md:w-10 transition-transform transform hover:-translate-y-1 hover:text-teal-500" icon={faGithub} />
          </a>
          <a href="https://drive.google.com/file/d/1Jfn9RAqFR3YaQbL8j_lJA0z8HHlLI3Xq/view?usp=sharing" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon className="w-[1.4rem] md:w-[1.8rem] transition-transform transform hover:-translate-y-1 hover:text-teal-500" icon={faFileLines} />
          </a>
          <a href="https://drive.google.com/file/d/1Jfn9RAqFR3YaQbL8j_lJA0z8HHlLI3Xq/view?usp=sharing" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon className="w-7 md:w-10 transition-transform transform hover:-translate-y-1 hover:text-teal-500" icon={faInstagram} />
          </a>
      </div>
      <div className='md:text-[7rem] md:font-extrabold'>
        <h1 className='mb-[-10px] md:mb-[-23px]'>SOFTWARE</h1>
        <h1>DEVELOPER</h1>
      </div>
