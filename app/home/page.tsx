...
const Home = () => {
  ...
  return (
    <>
    <div className="flex font-extrabold pl-7 pt-40 md:pt-20 text-5xl flex-col justify-start md:items-center md:justify-center lg:items-center lg:justify-center h-screen w-screen">
