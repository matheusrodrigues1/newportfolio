...
const Home = () => {
  ...
  return (
    ...
    <div className="flex bg-white font-extrabold pl-14 md:pt-20 text-5xl flex-col justify-center md:items-center md:justify-center lg:items-center lg:justify-center h-screen w-screen">
