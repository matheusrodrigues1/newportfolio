...
const Home = () => {
  ...
  return (
    <>
    <div className="flex bg-slate-200 font-extrabold pl-7 pt-40 md:pt-20 text-5xl flex-col justify-start md:items-center md:justify-center lg:items-center lg:justify-center h-screen w-screen">
      ...
      <div className='md:text-[7rem] lg:text-[8.6rem] md:font-extrabold'>
      ...
      <div className="w-80 md:w-[27rem] lg:w-[32rem] md:ml-[17rem] lg:ml-[25rem] mt-1 md:mt-0">
        <p className="font-normal md:font-semibold text-[0.65rem] md:text-sm lg:text-base text-left leading-3">TENHO 23 ANOS SOU DESENVOLVEDOR FULLSTACK COM 2 ANOS DE EXPERIÊNCIA TRABALHANDO COMO FREELANCER.</p>
      </div>
