    ...
    <>
      <div className="flex bg-[#fffc00] font-extrabold pl-14 md:pl-[4rem] md:pt-20 text-5xl flex-col justify-center md:items-center md:justify-center lg:items-center lg:justify-center h-screen w-screen">
        ...
        <div className="text-black md:text-[7rem] lg:text-[8.6rem] md:font-extrabold">
          <h1 translate="no" className="mb-[-10px] md:mb-[-23px] lg:mb-[-35px]">
            SOFTWARE
          </h1>
          <h1 translate="no">DEVELOPER</h1>
        </div>
        <div className="w-80 md:w-[27rem] lg:w-[32rem] md:ml-[17rem] lg:ml-[25rem] mt-1 mb-8 md:mt-0">
          <p className="font-normal text-[#363636] md:font-bold text-[0.75rem] md:text-[0.90rem] lg:text-base text-left leading-3">
            TENHO 23 ANOS, SOU DESENVOLVEDOR FULLSTACK COM 2 ANOS DE EXPERIÊNCIA
