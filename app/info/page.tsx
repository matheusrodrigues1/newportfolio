...
const Information = () => {
  return (
    <>
      <div className="flex bg-slate-200 border-t-2 border-[#dc2626] flex-col md:flex-row md:gap-10 h-screen w-screen justify-center items-center md:justify-center mt-6 pt-6">
        <div className="flex flex-col items-center md:w-[30rem] lg:w-[40rem]">
          <div className="flex flex-col gap-[0.35rem] lg:gap-[0.87rem]">
            <p className="text-sm text-black lg:text-lg pl-1"><span className="pl-[0.28rem] md:pl-[1rem]">Oi</span>, sou Matheus de Alagoas, um entusiasta de frontend com 2 anos de experiência. Tenho me dedicado ao estudo de tecnologias como <strong className="font-bold">React</strong>, <strong className="font-bold">HTML</strong>, <strong className="font-bold">CSS</strong>, <strong className="font-bold">SASS</strong>, <strong className="font-bold">JavaScript</strong>, <strong className="font-bold">Tailwind</strong>, <strong className="font-bold">MongoDB</strong>, <strong className="font-bold">Node.js</strong> e <strong className="font-bold">Bootstrap</strong>.<br/></p>
            <p className="text-sm text-black lg:text-lg pl-1">Recentemente, estou explorando <strong className="font-bold">TypeScript</strong> e <strong className="font-bold">Python</strong> para ampliar minha base de conhecimento. No <strong className="font-bold">Github</strong>, compartilho projetos com React e Python, e no LinkedIn, participo de discussões sobre desenvolvimento frontend.<br/></p>
            <p className="text-sm text-black lg:text-lg pl-1">Busco desafios e oportunidades para contribuir em projetos inovadores. Animado com meu crescimento contínuo, estou ansioso para aplicar minhas habilidades em projetos impactantes. Vamos conectar e trocar ideias!</p>
          </div>
