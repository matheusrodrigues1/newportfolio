...
const Projects = () => {
  return (
    <>
       <div className="flex items-center border-t-2 border-[#22c55e] bg-[#fffc00] justify-center min-h-screen container mx-auto">
          <div className="grid grid-cols-1 mt-7 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card">
              <div className="p-5 flex h-full bg-black rounded-lg flex-col">
            ...
            <div className="card">
              <div className="p-5 bg-black h-full rounded-lg flex flex-col">
                <div className="rounded-xl overflow-hidden">
                  <Image src={banner2} alt="banner"/>
                </div>
                <h5 className="text-2xl text-white md:text-3xl font-medium mt-3">Evently</h5>
                <p className="text-slate-500 text-sm mt-3">Evently é uma plataforma de eventos online, oferecendo cadastro e participação em uma variedade de atividades. Com integrações Next.js, Stripe, Clerk e MongoDB, além da utilização do framework Tailwind CSS, proporciona uma experiência simplificada e segura para organizadores e participantes.</p>
                <a href="#" className="text-center bg-blue-400 text-blue-700 py-2  rounded-lg font-semibold mt-4 hover:bg-blue-300 focus:scale-95 transition-all duration-200 ease-out">Explore</a>
              </div>
            </div>
            <div className="card">
              <div className="p-5 rounded-lg h-full bg-black flex flex-col">
                <div className="rounded-xl overflow-hidden">
